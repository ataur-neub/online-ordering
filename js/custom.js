$(document).ready(function() {
	...
	$(".sticky-content-left-side").on("sticky-start", function() {
        $(this).height() > $(window).height() && ($(this).height($(window).height() - 70), $(this).css("overflow-y", "auto"))
    }), $(".sticky-content-left-side").on("sticky-end", function() {
